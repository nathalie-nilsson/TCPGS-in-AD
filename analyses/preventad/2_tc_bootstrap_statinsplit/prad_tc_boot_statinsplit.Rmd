...
```{r}
score.files <- "analyses/preventad/1_pg_scoring/score_files/" # folder with score files
score.range <- "analyses/preventad/1_pg_scoring/scoring_range.txt" # scoring range file
```
