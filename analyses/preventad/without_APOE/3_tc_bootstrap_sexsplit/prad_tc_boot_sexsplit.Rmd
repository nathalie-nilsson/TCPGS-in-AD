---
title: "Bootstrap TC ~ TC pgs in PRAD: stratified for sex"
...
```{r}
pheno.file <- "analyses/preventad/without_APOE/2_tc_bootstrap_statinsplit/prad_tc_boot_data.txt"
...
Output parameters:
```{r}
output.name.org <- "prad_tc_boot_sexsplit"
```
