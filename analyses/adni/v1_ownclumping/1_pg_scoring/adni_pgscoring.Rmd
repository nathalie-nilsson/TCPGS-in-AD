...
base.file.snps.clump    <- "data/willer/willer_tc_adni_match/willer_tc_adni_match_snps_clump.txt"
...
## Libraries
Note: also depends on PLINK v1.9 (https://www.cog-genomics.org/plink/)
```{r}
library(tidyverse)
```
